...
python3 vae_main.py --base ./configs/stable-diffusion/rgbd/sd_rgb_1e-5.yaml --resume ./logs/sd_rgb_1e-5/checkpoints/last.ckpt --scale_lr False  --gpus 0,1,2,3,4,5,6,7,
