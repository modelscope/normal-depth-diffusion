...
def load_model(model_type):
    ...
    elif model_type == "dpt_beit_large_512":  # Midas 3.1
        if not os.path.exists(model_path):
            raise NotImplementedError("Not find model ckpt {}".format(model_path))
    ...
    elif model_type == "dpt_beit_large_384":  # Midas 3.1
        if not os.path.exists(model_path):
            raise NotImplementedError("Not find model ckpt {}".format(model_path))
