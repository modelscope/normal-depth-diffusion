...
from .backbones.beit import (_make_pretrained_beitb16_384,
                             _make_pretrained_beitl16_384,
                             _make_pretrained_beitl16_512, forward_beit)
...
from .backbones.swin2 import (_make_pretrained_swin2b24_384,
                              _make_pretrained_swin2l24_384,
                              _make_pretrained_swin2t16_256)
from .backbones.swin_common import forward_swin
from .backbones.vit import (_make_pretrained_vitb16_384,
...
def _make_encoder(backbone,
    ...
    if backbone == 'beitl16_512':
        ...
        scratch = _make_scratch([256, 512, 1024, 1024],
                                features,
                                groups=groups,
                                expand=expand)  # BEiT_512-L (backbone)
        ...
        scratch = _make_scratch(
            in_features, features, groups=groups,
            expand=expand)  # Next-ViT-L on ImageNet-1K-6M (backbone)
    elif backbone == 'levit_384':
        pretrained = _make_pretrained_levit_384(use_pretrained, hooks=hooks)
        scratch = _make_scratch([384, 512, 768],
                                features,
                                groups=groups,
                                expand=expand)  # LeViT 384 (backbone)
