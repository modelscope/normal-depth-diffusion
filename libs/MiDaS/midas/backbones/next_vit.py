...
def _make_next_vit_backbone(
    ...
    pretrained.model.features[hooks[0]].register_forward_hook(
        get_activation('1'))
    pretrained.model.features[hooks[1]].register_forward_hook(
        get_activation('2'))
    pretrained.model.features[hooks[2]].register_forward_hook(
        get_activation('3'))
    pretrained.model.features[hooks[3]].register_forward_hook(
        get_activation('4'))
