...
class DPT(BaseModel):
    ...
    def __init__(self,
        ...
        hooks = {
            ...
            'swin2l24_384':
            [1, 1, 17,
             1],  # Allowed ranges: [0, 1], [0,  1], [ 0, 17], [ 0,  1]
            'swin2b24_384': [1, 1, 17,
                             1],  # [0, 1], [0,  1], [ 0, 17], [ 0,  1]
            'swin2t16_256': [1, 1, 5,
                             1],  # [0, 1], [0,  1], [ 0,  5], [ 0,  1]
            'swinl12_384': [1, 1, 17,
                            1],  # [0, 1], [0,  1], [ 0, 17], [ 0,  1]
            'next_vit_large_6m': [2, 6, 36,
                                  39],  # [0, 2], [3,  6], [ 7, 36], [37, 39]
...
class DPTDepthModel(DPT):
    ...
    def __init__(self, path=None, non_negative=True, **kwargs):
        ...
        head_features_1 = kwargs[
            'head_features_1'] if 'head_features_1' in kwargs else features
        head_features_2 = kwargs[
            'head_features_2'] if 'head_features_2' in kwargs else 32
