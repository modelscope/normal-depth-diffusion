...
def _gen_mobilenet_v3_rw(variant,
                         channel_multiplier=1.0,
                         pretrained=False,
                         **kwargs):
    ...
    arch_def = [
        ...
        ['ir_r1_k3_s2_e6_c80', 'ir_r1_k3_s1_e2.5_c80',
         'ir_r2_k3_s1_e2.3_c80'],  # hard-swish
        # stage 4, 14x14in
    ...
    with layer_config_kwargs(kwargs):
        model_kwargs = dict(
            ...
            se_kwargs=dict(
                gate_fn=get_act_fn('hard_sigmoid'), reduce_mid=True),
    ...
    if 'small' in variant:
        ...
        if 'minimal' in variant:
            ...
            arch_def = [
                ...
                # stage 1, 56x56 in
                ['ir_r1_k3_s2_e4.5_c24_nre',
                 'ir_r1_k3_s1_e3.67_c24_nre'],  # relu
                # stage 2, 28x28 in
