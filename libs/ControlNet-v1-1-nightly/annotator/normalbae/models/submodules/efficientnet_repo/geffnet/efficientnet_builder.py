...
__all__ = [
    'get_bn_args_tf', 'resolve_bn_args', 'resolve_se_args',
    'resolve_act_layer', 'make_divisible', 'round_channels', 'drop_connect',
    'SqueezeExcite', 'ConvBnAct', 'DepthwiseSeparableConv', 'InvertedResidual',
    'CondConvResidual', 'EdgeResidual', 'EfficientNetBuilder',
    'decode_arch_def', 'initialize_weight_default', 'initialize_weight_goog',
...
class EdgeResidual(nn.Module):
    ...
    def __init__(self,
        ...
        mid_chs = make_divisible(
            fake_in_chs
            * exp_ratio) if fake_in_chs > 0 else make_divisible(in_chs
                                                                * exp_ratio)
        self.has_residual = (in_chs == out_chs and stride == 1) and not noskip
        self.drop_connect_rate = drop_connect_rate
...
class EfficientNetBuilder:
    ...
    def _make_block(self, ba):
        ...
        ba['act_layer'] = ba['act_layer'] if ba[
            'act_layer'] is not None else self.act_layer
