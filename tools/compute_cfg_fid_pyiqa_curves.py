...
def get_parse():
    ...
    parser.add_argument(
        '--total_size', default=2000, help='train or test', type=int)
    parser.add_argument(
        '--type', default='cfg', help='train or test', type=str)
...
if __name__ == '__main__':
    ...
    metric_path = os.path.join(save_path, 'fid_cfg_metric.npz')
    ...
    folder_chain = sorted(glob.glob(os.path.join(args.path, 'test_cfg_*')))
    x_aixs = [
