...
def main():
    ...
    metric_path = os.path.join(save_path, 'clip_cfg_metric.npz')
    ...
    folder_chain = sorted(glob.glob(os.path.join(args.ref_path, 'test_cfg_*')))
    x_aixs = [
    ...
    plt.savefig(os.path.join(save_path, 'clip_cfg.png'))
